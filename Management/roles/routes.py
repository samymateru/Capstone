...
def get_company_roles(
    ...
    try:
        ...
        if roles_data.__len__() == 0:
            return {"detail": "no roles available", "status_code": 201, "payload": []}
...
def update_role(
    ...
    try:
        ...
        return {"detail": "roles successfully updated", "status_code": 502}
    except HTTPException as e:
        return HTTPException(status_code=e.status_code, detail=e.detail)
...
def delete(
    ...
    if current_user.type != "admin":
        return HTTPException(status_code=101, detail="Your not admin")
    try:
        databases.delete_role(db, role_id.role_id)
        return {"detail": "successfully delete the role", "status_code": 503}
    except HTTPException as e:
        return HTTPException(status_code=e.status_code, detail=e.detail)
